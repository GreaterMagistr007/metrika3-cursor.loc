<template>
  <div class="fixed top-4 left-4 right-4 sm:left-auto sm:right-4 z-50 space-y-2">
    <TransitionGroup name="toast" tag="div">
      <div
        v-for="toast in toasts"
        :key="toast.id"
        class="w-full min-w-[420px] max-w-[420px] bg-white shadow-lg rounded-lg pointer-events-auto ring-1 ring-black ring-opacity-5 overflow-hidden"
...
const toasts = computed(() => messageStore.toasts);
